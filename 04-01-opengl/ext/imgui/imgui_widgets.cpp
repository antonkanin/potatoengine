                        ...
                        void*                  callback_user_data)
{
    ...
    if (render_cursor || render_selection)
    {
        ...
        if (is_multiline ||
            ...
            draw_window->DrawList->AddText(
                g.Font, g.FontSize, draw_pos - draw_scroll,
                GetColorU32(ImGuiCol_Text), buf_display, buf_display_end, 0.0f,
    ...
    else
    {
        ...
        if (is_multiline ||
            (buf_display_end - buf_display) < buf_display_max_length)
            draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos,
                                           GetColorU32(ImGuiCol_Text),
